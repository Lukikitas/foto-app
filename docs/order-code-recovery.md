...
1. Aplicar primero la migración anterior y después `supabase/migrations/20260926150000_scheduled_order_recovery.sql`. Esta última agrega el agregador explícito a las fotos, una configuración compartida (desactivada por defecto, 03:00 de Argentina, solo propuestas), ejecuciones reanudables y auditoría.
